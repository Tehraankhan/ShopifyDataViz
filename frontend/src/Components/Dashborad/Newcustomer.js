...
export default function Newcustomer() {
  ...
  const chartOptions = {
    ...
    scales: {
      ...
      y: {
        title: {
          display: true,
          text: "Total no of new customers", // Y-axis label
          color: "black", // Label color
          font: {
            size: 16, // Increase the font size for x-axis title
          },
  ...
  return (
    <>
      <div id="Newcustomer" className="flex flex-col w-[95%] h-[600px] border-1 border-[black] rounded-[5px] mx-auto my-[70px] shadow-2xl bg-white">
        <h1 className="text-center text-[30px]">New Customers Added Over Time</h1>
